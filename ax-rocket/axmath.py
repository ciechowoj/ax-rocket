...
def project2(vector, normal):
    projection = normal * dot2(vector, normal)
...
def circleRectangleIntersect(circle_position, circle_radius, rectangle_position, rectangle_size):
    ...
    return distance.x < dist_lim.x and distance.y < dist_lim.y
